            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="tel" class="col-md-4 col-form-label text-md-right">เบอร์โทรศัพท์</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="isAdmin" class="form-control @error('isAdmin') is-invalid @enderror" id="isAdmin" required>
